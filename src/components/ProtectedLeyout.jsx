...
export default function DefaultLeyout (){
   ...
   return(
    <>
      <nav className="bg-white border-grey-200 px-2 py-3">
            <div className="container flex flex-wrap item-center justify-between mx-auto">
                <a href="#" className="flex item-center">
                    ...
                    <span className="self-center text-xl whitespace-nowrap">FirmNm</span>
                </a>
                <button data-collapse-toggle="navbar-default" 
                type="button"
                className="inline-flex item-center p-2 ml-3 text-sm text-grey-500 rounded-lg hover:bg-grey-100 focus:outline-name focus:ring-grey-200"
      ...
      <main className="container flex justify-center flex-col item-center mt-10">
        <Outlet/>
      </main>
    </>
   )
